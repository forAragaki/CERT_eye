...
class Showalgo extends React.Component{
  static propTypes = {
  ...
  handledata(){
    const url = "https://nanase.ink:5001/cert_sig_algo"+"?school="+ global.constants.param;
...
export default function(props){
  ...
  return <Showalgo {...props} theme={theme} classes={classes}/>;
}