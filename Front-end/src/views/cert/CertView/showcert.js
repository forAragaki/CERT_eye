...
class Showcert extends React.Component{
  static propTypes = {
  ...
  handledata(){
    const url = "https://nanase.ink:5001/certvalid"+"?school="+ global.constants.param;
...
export default function(props){
  ...
  return <Showcert {...props} theme={theme} classes={classes}/>;
}